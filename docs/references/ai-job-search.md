...
에 정리가 잘된 설정 — 이게 일반적인 AI 이용 수준의 패턴인가?" 라고 직접 질의한 대상. EPDS 어느 단계에
기여: Spec/Build/Verify — `docs/LAYOUT.md`(에이전트 중립 코어+얇은 어댑터 트리)의 1차 원본.
...
> description(gh api 실측 2026-09-16, stars 43033).
